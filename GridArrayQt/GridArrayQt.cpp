...
Create picture array for OLED screen.\n\n\
Version 1.2"));
	});
...
void GridArrayQt::setupDockwidget()
{
	...
	connect(ui->hSlider_GridColor,&QSlider::valueChanged,
		[=](int value){pDrawArea->setCursorGray(value);});
...
byte GridArrayQt::judgeType(QString &str)
{
...
bool GridArrayQt::loadFile(byte type,QString &str)
{
